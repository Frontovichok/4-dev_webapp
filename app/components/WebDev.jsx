		...
		const courses = [
            {
				...
				extendData: [
                    ...
                    {title: "Стилевые фреймворки", data: [{title: "Bootstrap", version: "N", img: "../img/js_icon.png"}]},
                    {title: "Препроцессоры CSS", data: [{title: "Sass", version: "N", img: "../img/js_icon.png"}, {title: "Less", version: "N", img: "../img/js_icon.png"}, {title: "..ss", version: "N", img: "../img/js_icon.png"}]},
				],
                details: [
